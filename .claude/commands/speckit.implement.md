---
description: "Execute implementation tasks from tasks.md in TDD order, committing after each phase. The AI agent writes tests first, verifies failures, then implements."
---
